...
function setStretchStyle(element) {
  ...
  /** To track the starting position of the touch  @type {Array<number>} */ let fingerStart = [];
  /** To track the maximum magnitude of strecthening  @type {Array<number>} */ let maxStretchReached = [0,0];
  /** To track the maximum displacement  @type {Array<number>} */ let maxDisplacement = [0,0];
